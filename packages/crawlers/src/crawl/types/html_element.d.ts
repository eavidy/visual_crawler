interface NodeList<T extends Node = Node> {
    ...
    forEach(callbackfn: (value: Node, key: number, parent: NodeList<T>) => void, thisArg?: any): void;
    [index: number]: T;
}
...
interface HTMLCollection<T extends Element = Element> extends HTMLCollectionBase {
...
export interface Element extends Node, Node, InnerHTML, NonDocumentTypeChildNode, ParentNode {
