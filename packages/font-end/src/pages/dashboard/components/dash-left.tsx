...
import { Top20Billboard } from "./charts/billboard.tsx";
import { LineChart } from "./charts/line-chart.tsx";
import { PipChart } from "./charts/pip-chart.tsx";
...
function JobBillboard(props: { filterOptions: ApiReq.MatchFilter }) {
  const { data: dataByJob, loading: jobDataLoading } = useRequest(
    () => {
      if (props.filterOptions.jobName)
        return dashboardService.getAnalysisByJob(props.filterOptions);
