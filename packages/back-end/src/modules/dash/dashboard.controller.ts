...
import type { MatchFilter } from "../../services/db/job_analysis.db.service.js";
...
export class DashboardCtrl {
  ...
  async getAnalysisCity(
    @Query() query: MatchFilter,
  ): Promise<ApiRes.AnalysisByCity> {
  ...
  @Get("job_billboard")
  @UsePipes(validationPipe)
  async getJobBillboard(
    @Query() query: MatchFilter,
  ): Promise<ApiRes.JobBillboard> {
